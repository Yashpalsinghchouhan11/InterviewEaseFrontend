    ...
    <div className="fixed inset-0 flex items-center justify-center">
      <div className=" max-w-md w-full p-8 bg-white rounded-lg shadow-lg">
        ...
        <form action="" onSubmit={handleSubmit} className="flex flex-col my-4">
          ...
          <button  className="bg-[#9381FF] hover:bg-[#7a6ffb] p-2 cursor-pointer rounded-md my-4 text-white ">
            Login
          </button>
          <div className="flex items-center justify-center mb-2">
            <span>Don't have an account? </span>
            <Link to="/signup" className="text-[#7a6ffb] ml-1">
              Signup
            </Link>
          </div>
          <Link to="" className="text-center text-[#7a6ffb]">
