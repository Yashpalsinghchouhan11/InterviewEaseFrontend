    ...
    <div className="fixed inset-0 flex items-center justify-center">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg ">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col my-4">
          ...
          <button
            type="submit"
            className={`p-2 rounded-md my-4 text-white ${
              loading ? "bg-gray-400 cursor-not-allowed" : "bg-[#9381FF] hover:bg-[#7a6ffb] cursor-pointer"
            }`}
          ...
          <div className="flex items-center justify-center mb-2">
            ...
            <Link to="/login" className="text-[#7a6ffb] ml-1">
              Login
            </Link>
          </div>
        </form>
